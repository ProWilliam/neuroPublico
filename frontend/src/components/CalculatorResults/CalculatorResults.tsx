      ...
      <>
        <div className="sales-calculator">
          <div className="header">
            <div className="title">Calculadora de ventas</div>
            <div className="header-right">
              <div className="button-return" onClick={handleBackProduct}>
               <ArrowReturnIcon />
              </div>
              <div className="prices">
                <div className="currency-switch left">
                  <span>$</span>
                  <span>USD</span>
                </div>
                <div className="currency-switch right activate">
                  <span>$</span>
                  <span>COP</span>
                </div>
              </div>
        ...
        <div className="result-container">
          <div className="sidebar-resul">
            ...
            <input type="number" name="Utils Products" id="utils" placeholder='$ 1,000,000' />
